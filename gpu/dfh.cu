...
extern "C" void ScaLBL_D3Q19_AAeven_DFH(int *Map, double *dist, double *Aq, double *Bq, double *Den, double *Phi,
...
extern "C" void ScaLBL_D3Q19_AAodd_DFH(int *d_neighborList, int *Map, double *dist, double *Aq, double *Bq, double *Den, 
