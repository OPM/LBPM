...
void Domain::CommInit()
{
	...
	recvList_XZ.resize( recvCount_XZ, 0 );
	//......................................................................................
	req1[0] = Comm.Isend(sendList_x.data(),sendCount_x,rank_x(),sendtag+0);
	req2[0] = Comm.Irecv(recvList_X.data(),recvCount_X,rank_X(),recvtag+0);
	req1[1] = Comm.Isend(sendList_X.data(),sendCount_X,rank_X(),sendtag+1);
	req2[1] = Comm.Irecv(recvList_x.data(),recvCount_x,rank_x(),recvtag+1);
	req1[2] = Comm.Isend(sendList_y.data(),sendCount_y,rank_y(),sendtag+2);
	req2[2] = Comm.Irecv(recvList_Y.data(),recvCount_Y,rank_Y(),recvtag+2);
	req1[3] = Comm.Isend(sendList_Y.data(),sendCount_Y,rank_Y(),sendtag+3);
	req2[3] = Comm.Irecv(recvList_y.data(),recvCount_y,rank_y(),recvtag+3);
	req1[4] = Comm.Isend(sendList_z.data(),sendCount_z,rank_z(),sendtag+4);
	req2[4] = Comm.Irecv(recvList_Z.data(),recvCount_Z,rank_Z(),recvtag+4);
	req1[5] = Comm.Isend(sendList_Z.data(),sendCount_Z,rank_Z(),sendtag+5);
	req2[5] = Comm.Irecv(recvList_z.data(),recvCount_z,rank_z(),recvtag+5);
	req1[6] = Comm.Isend(sendList_xy.data(),sendCount_xy,rank_xy(),sendtag+6);
	req2[6] = Comm.Irecv(recvList_XY.data(),recvCount_XY,rank_XY(),recvtag+6);
	req1[7] = Comm.Isend(sendList_XY.data(),sendCount_XY,rank_XY(),sendtag+7);
	req2[7] = Comm.Irecv(recvList_xy.data(),recvCount_xy,rank_xy(),recvtag+7);
	req1[8] = Comm.Isend(sendList_Xy.data(),sendCount_Xy,rank_Xy(),sendtag+8);
	req2[8] = Comm.Irecv(recvList_xY.data(),recvCount_xY,rank_xY(),recvtag+8);
	req1[9] = Comm.Isend(sendList_xY.data(),sendCount_xY,rank_xY(),sendtag+9);
	req2[9] = Comm.Irecv(recvList_Xy.data(),recvCount_Xy,rank_Xy(),recvtag+9);
	req1[10] = Comm.Isend(sendList_xz.data(),sendCount_xz,rank_xz(),sendtag+10);
	req2[10] = Comm.Irecv(recvList_XZ.data(),recvCount_XZ,rank_XZ(),recvtag+10);
	req1[11] = Comm.Isend(sendList_XZ.data(),sendCount_XZ,rank_XZ(),sendtag+11);
	req2[11] = Comm.Irecv(recvList_xz.data(),recvCount_xz,rank_xz(),recvtag+11);
	req1[12] = Comm.Isend(sendList_Xz.data(),sendCount_Xz,rank_Xz(),sendtag+12);
	req2[12] = Comm.Irecv(recvList_xZ.data(),recvCount_xZ,rank_xZ(),recvtag+12);
	req1[13] = Comm.Isend(sendList_xZ.data(),sendCount_xZ,rank_xZ(),sendtag+13);
	req2[13] = Comm.Irecv(recvList_Xz.data(),recvCount_Xz,rank_Xz(),recvtag+13);
	req1[14] = Comm.Isend(sendList_yz.data(),sendCount_yz,rank_yz(),sendtag+14);
	req2[14] = Comm.Irecv(recvList_YZ.data(),recvCount_YZ,rank_YZ(),recvtag+14);
	req1[15] = Comm.Isend(sendList_YZ.data(),sendCount_YZ,rank_YZ(),sendtag+15);
	req2[15] = Comm.Irecv(recvList_yz.data(),recvCount_yz,rank_yz(),recvtag+15);
	req1[16] = Comm.Isend(sendList_Yz.data(),sendCount_Yz,rank_Yz(),sendtag+16);
	req2[16] = Comm.Irecv(recvList_yZ.data(),recvCount_yZ,rank_yZ(),recvtag+16);
	req1[17] = Comm.Isend(sendList_yZ.data(),sendCount_yZ,rank_yZ(),sendtag+17);
	req2[17] = Comm.Irecv(recvList_Yz.data(),recvCount_Yz,rank_Yz(),recvtag+17);
	Comm.waitAll(18,req1);
	Comm.waitAll(18,req2);
	//......................................................................................
