...
M2_pore<-2*CapArea(r1,r1)/r1+CylArea(r1,L1)/r1+2*pi*xt_pore
Jwn_pore<-2/rt_pore
...
M2_pin<-2*CapArea(r1,r1)/r1+CylArea(r1,L1)/r1+2*pi*Hb+2*pi*ht_pin
Jwn_pin<-2/rt_pin
...
M2_outlet<-2*CapArea(r2,r2)/r2+CylArea(r2,time*0.01*L2)/r2
...
p2<-ggplot()+geom_line(aes(sw,Jwn))+GGTHEME+
