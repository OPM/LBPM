...
void dvc_ScaLBL_D3Q19_FreeLeeModel_TwoFluid_Init(double *gqbar, double *mu_phi, double *ColorGrad, double Fx, double Fy, double Fz, int Np,
...
void dvc_ScaLBL_D3Q19_FreeLeeModel_SingleFluid_Init(double *gqbar, double Fx, double Fy, double Fz, int Np,
                                                    sycl::nd_item<3> item_ct1)
{
	int n;
    double p = 1.0;//NOTE: take initial pressure p=1.0
...
void dvc_ScaLBL_FreeLeeModel_PhaseField_Init(int *Map, double *Phi, double *Den, double *hq, double *ColorGrad, 
	...
	for (idx=start; idx<finish; idx++){
        ...
        cg_mag = sycl::sqrt(nx * nx + ny * ny + nz * nz);
...
void dvc_ScaLBL_D3Q7_AAodd_FreeLeeModel_PhaseField(int *neighborList, int *Map, double *hq, double *Den, double *Phi, 
...
void dvc_ScaLBL_D3Q7_AAeven_FreeLeeModel_PhaseField( int *Map, double *hq, double *Den, double *Phi,
		double rhoA, double rhoB, int start, int finish, int Np,
		sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q7_AAodd_FreeLee_PhaseField(int *neighborList, int *Map, double *hq, double *Den, double *Phi, double *ColorGrad, double *Vel,
		double rhoA, double rhoB, double tauM, double W, int start, int finish, int Np,
		sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q7_AAeven_FreeLee_PhaseField( int *Map, double *hq, double *Den, double *Phi, double *ColorGrad, double *Vel,
		double rhoA, double rhoB, double tauM, double W, int start, int finish, int Np,
		sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q7_ComputePhaseField(int *Map,  double *hq, double *Den, double *Phi, double rhoA, double rhoB, int start, int finish, int Np,
                                       sycl::nd_item<3> item_ct1){
	int idx,n;
	double h0,h1,h2,h3,h4,h5,h6;
	double phi;
...
void dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel(int *neighborList, int *Map, double *dist, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
    ...
    for (int s=0; s<S; s++){
    	//........Get 1-D index for this thread....................
        n = S * item_ct1.get_group(2) * item_ct1.get_local_range(2) +
            s * item_ct1.get_local_range(2) + item_ct1.get_local_id(2) + start;
...
void dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel(int *Map, double *dist, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        double rhoA, double rhoB, double tauA, double tauB, double kappa, double beta, double W, double Fx, double Fy, double Fz, 
        int strideY, int strideZ, int start, int finish, int Np,
        sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined(int *neighborList, int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
    ...
    for (int s=0; s<S; s++){
        ...
        if ( n<finish ){
            ...
            double mg_mag = sycl::sqrt(mgx * mgx + mgy * mgy + mgz * mgz);
            ...
            if (sycl::fabs(chem) < 1.0e-12) chem = 0.0;
...
void dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined(int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        double rhoA, double rhoB, double tauA, double tauB, double tauM, double kappa, double beta, double W, double Fx, double Fy, double Fz, 
        int strideY, int strideZ, int start, int finish, int Np,
        sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined_HigherOrder(int *neighborList, int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
        double rhoA, double rhoB, double tauA, double tauB, double tauM, double kappa, double beta, double W, double Fx, double Fy, double Fz, 
        int strideY, int strideZ, int start, int finish, int Np,
        sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined_HigherOrder(int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        double rhoA, double rhoB, double tauA, double tauB, double tauM, double kappa, double beta, double W, double Fx, double Fy, double Fz, 
        int strideY, int strideZ, int start, int finish, int Np,
        sycl::nd_item<3> item_ct1){
...
void dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_SingleFluid_BGK(int *neighborList, double *dist, double *Vel, double *Pressure,  
...
void dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_SingleFluid_BGK(double *dist, double *Vel, double *Pressure, 
		double tau, double rho0, double Fx, double Fy, double Fz, int start, int finish, int Np,
		sycl::nd_item<3> item_ct1){
...
extern "C" void ScaLBL_D3Q19_FreeLeeModel_TwoFluid_Init(double *gqbar, double *mu_phi, double *ColorGrad, double Fx, double Fy, double Fz, int Np){
        ...
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_FreeLeeModel_TwoFluid_Init(
                        gqbar, mu_phi, ColorGrad, Fx, Fy, Fz, Np, item_ct1);
            });
        /*
        DPCT1010:220: SYCL uses exceptions to report errors and does not use the
...
extern "C" void ScaLBL_D3Q19_FreeLeeModel_SingleFluid_Init(double *gqbar, double Fx, double Fy, double Fz, int Np){
        ...
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_FreeLeeModel_SingleFluid_Init(
                        gqbar, Fx, Fy, Fz, Np, item_ct1);
            });
        /*
        DPCT1010:222: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_FreeLeeModel_PhaseField_Init(int *Map, double *Phi, double *Den, double *hq, double *ColorGrad, 
        ...
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_FreeLeeModel_PhaseField_Init(
                        Map, Phi, Den, hq, ColorGrad, rhoA, rhoB, tauM, W,
                        start, finish, Np);
            });
        /*
        DPCT1010:224: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
{
        /*
        DPCT1026:226: The call to cudaFuncSetCacheConfig was removed because
        ...
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q7_AAodd_FreeLeeModel_PhaseField(
                        neighborList, Map, hq, Den, Phi, rhoA, rhoB, start,
                        finish, Np, item_ct1);
            });
        /*
        DPCT1010:227: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q7_AAeven_FreeLeeModel_PhaseField( int *Map, double *hq, double *Den, double *Phi, 
        ...
        /*
        DPCT1026:229: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q7_AAeven_FreeLeeModel_PhaseField(
                        Map, hq, Den, Phi, rhoA, rhoB, start, finish, Np,
                        item_ct1);
            });
        /*
...
extern "C" void ScaLBL_D3Q7_ComputePhaseField(int *Map,  double *hq, double *Den, double *Phi, double rhoA, double rhoB, int start, int finish, int Np){
        ...
        /*
        DPCT1026:232: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q7_ComputePhaseField(Map, hq, Den, Phi, rhoA,
                                                      rhoB, start, finish, Np,
                                                      item_ct1);
            });
        /*
        DPCT1010:233: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q19_AAodd_FreeLeeModel(int *neighborList, int *Map, double *dist, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
        ...
        /*
        DPCT1026:235: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel(
                        neighborList, Map, dist, Den, Phi, mu_phi, Vel,
                        Pressure, ColorGrad, rhoA, rhoB, tauA, tauB, kappa,
                        beta, W, Fx, Fy, Fz, strideY, strideZ, start, finish,
                        Np, item_ct1);
            });
        /*
        DPCT1010:236: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q19_AAeven_FreeLeeModel(int *Map, double *dist, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        ...
        /*
        DPCT1026:238: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel(
                        Map, dist, Den, Phi, mu_phi, Vel, Pressure, ColorGrad,
                        rhoA, rhoB, tauA, tauB, kappa, beta, W, Fx, Fy, Fz,
                        strideY, strideZ, start, finish, Np, item_ct1);
            });
        /*
        DPCT1010:239: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined(int *neighborList, int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
        ...
        /*
        DPCT1026:241: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined(
                        neighborList, Map, dist, hq, Den, Phi, mu_phi, Vel,
                        Pressure, ColorGrad, rhoA, rhoB, tauA, tauB, tauM,
                        kappa, beta, W, Fx, Fy, Fz, strideY, strideZ, start,
                        finish, Np, item_ct1);
            });
        /*
...
extern "C" void ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined(int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        ...
        /*
        DPCT1026:244: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined(
                        Map, dist, hq, Den, Phi, mu_phi, Vel, Pressure,
                        ColorGrad, rhoA, rhoB, tauA, tauB, tauM, kappa, beta, W,
                        Fx, Fy, Fz, strideY, strideZ, start, finish, Np,
                        item_ct1);
            });
        /*
        DPCT1010:245: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined_HigherOrder(int *neighborList, int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad, 
        ...
        /*
        DPCT1026:247: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_Combined_HigherOrder(
                        neighborList, Map, dist, hq, Den, Phi, mu_phi, Vel,
                        Pressure, ColorGrad, rhoA, rhoB, tauA, tauB, tauM,
                        kappa, beta, W, Fx, Fy, Fz, strideY, strideZ, start,
                        finish, Np, item_ct1);
...
extern "C" void ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined_HigherOrder(int *Map, double *dist, double *hq, double *Den,	double *Phi, double *mu_phi, double *Vel, double *Pressure, double *ColorGrad,
        ...
        /*
        DPCT1026:250: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_Combined_HigherOrder(
                        Map, dist, hq, Den, Phi, mu_phi, Vel, Pressure,
                        ColorGrad, rhoA, rhoB, tauA, tauB, tauM, kappa, beta, W,
                        Fx, Fy, Fz, strideY, strideZ, start, finish, Np,
                        item_ct1);
...
extern "C" void ScaLBL_D3Q19_AAodd_FreeLeeModel_SingleFluid_BGK(int *neighborList, double *dist, double *Vel, double *Pressure,  
        ...
        /*
        DPCT1026:253: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAodd_FreeLeeModel_SingleFluid_BGK(
                        neighborList, dist, Vel, Pressure, tau, rho0, Fx, Fy,
                        Fz, start, finish, Np, item_ct1);
            });
        /*
        DPCT1010:254: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
...
extern "C" void ScaLBL_D3Q19_AAeven_FreeLeeModel_SingleFluid_BGK(double *dist, double *Vel, double *Pressure, 
        ...
        /*
        DPCT1026:256: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAeven_FreeLeeModel_SingleFluid_BGK(
                        dist, Vel, Pressure, tau, rho0, Fx, Fy, Fz, start,
                        finish, Np, item_ct1);
            });
        /*
