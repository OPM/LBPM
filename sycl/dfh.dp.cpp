...
void dvc_ScaLBL_Gradient_Unpack(double weight, double Cqx, double Cqy, double Cqz, 
	...
	double value, tmp;
		...
		if (!(n<0)){
			...
			tmp = Cqx*value;
			// BUILD_FIX_AFTER_MIGRATION : Replaced generic_space with global_space(with generic_space not able to generate many target binaries).
                        dpct::atomic_fetch_add<
                            double, sycl::access::address_space::global_space>(
                            &grad[n], tmp);
...
void dvc_ScaLBL_DFH_Init(double *Phi, double *Den, double *Aq, double *Bq, int start, int finish, int Np,
                         sycl::nd_item<3> item_ct1){
	int idx;
	double phi,nA,nB;
...
void dvc_ScaLBL_D3Q19_AAeven_DFH(int *neighborList, double *dist, double *Aq, double *Bq, double *Den, double *Phi,
...
void dvc_ScaLBL_D3Q19_AAodd_DFH(int *neighborList, double *dist, double *Aq, double *Bq, double *Den, 
...
void dvc_ScaLBL_D3Q7_AAodd_DFH(int *neighborList, double *Aq, double *Bq, 
...
void dvc_ScaLBL_D3Q7_AAeven_DFH(double *Aq, double *Bq, double *Den, double *Phi, 
...
void dvc_ScaLBL_D3Q19_Gradient_DFH(int *neighborList, double *Phi, double *ColorGrad, int start, int finish, int Np,
                                   sycl::nd_item<3> item_ct1){
        ...
        */
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, GRID) *
                              ...
                              sycl::range<3>(1, 1, 512)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_Gradient_Unpack(weight, Cqx, Cqy, Cqz, list,
                                               start, count, recvbuf, phi, grad,
                                               N, item_ct1);
            });
        /*
...
extern "C" void ScaLBL_DFH_Init(double *Phi, double *Den, double *Aq, double *Bq, int start, int finish, int Np){
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_DFH_Init(Phi, Den, Aq, Bq, start, finish, Np,
                                        item_ct1);
            });
        /*
...
extern "C" void ScaLBL_D3Q19_AAeven_DFH(int *neighborList, double *dist, double *Aq, double *Bq, double *Den, double *Phi,
        ...
        /*
        DPCT1007:130: Migration of cudaProfilerStart is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStart();
        /*
        DPCT1026:131: The call to cudaFuncSetCacheConfig was removed because
        ...
        */
        ...
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_AAeven_DFH(
                        neighborList, dist, Aq, Bq, Den, Phi, Gradient,
                        SolidForce, rhoA, rhoB, tauA, tauB, alpha, beta, Fx, Fy,
        ...
        */
        ...
        /*
        DPCT1007:132: Migration of cudaProfilerStop is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStop();
}
...
extern "C" void ScaLBL_D3Q19_AAodd_DFH(int *neighborList, double *dist, double *Aq, double *Bq, double *Den, 
        ...
        /*
        DPCT1007:135: Migration of cudaProfilerStart is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStart();
        /*
        DPCT1026:136: The call to cudaFuncSetCacheConfig was removed because
        SYCL currently does not support configuring shared memory on devices.
        */
        ...
        */
        ...
        /*
        DPCT1007:137: Migration of cudaProfilerStop is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStop();
}
...
extern "C" void ScaLBL_D3Q7_AAodd_DFH(int *NeighborList, double *Aq, double *Bq, 
        ...
        /*
        DPCT1007:140: Migration of cudaProfilerStart is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStart();
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q7_AAodd_DFH(NeighborList, Aq, Bq, Den, Phi,
                                              start, finish, Np, item_ct1);
            });

        /*
        DPCT1010:142: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
        ...
        /*
        DPCT1007:141: Migration of cudaProfilerStop is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStop();
}
...
extern "C" void ScaLBL_D3Q7_AAeven_DFH(double *Aq, double *Bq, double *Den, double *Phi, 
        ...
        /*
        DPCT1007:144: Migration of cudaProfilerStart is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStart();
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q7_AAeven_DFH(Aq, Bq, Den, Phi, start, finish,
                                               Np, item_ct1);
            });
        /*
        DPCT1010:146: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
        ...
        /*
        DPCT1007:145: Migration of cudaProfilerStop is not supported.
        */
		// BUILD_FIX_AFTER_MIGRATION : Commented below line.
        //cudaProfilerStop();
}
...
extern "C" void ScaLBL_D3Q19_Gradient_DFH(int *neighborList, double *Phi, double *ColorGrad, int start, int finish, int Np){
        ...
        dpct::get_default_queue().parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, NBLOCKS) *
                              ...
                              sycl::range<3>(1, 1, NTHREADS)),
            [=](sycl::nd_item<3> item_ct1) {
                    dvc_ScaLBL_D3Q19_Gradient_DFH(neighborList, Phi, ColorGrad,
                                                  start, finish, Np, item_ct1);
            });
        /*
        DPCT1010:148: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        int err = 0;
