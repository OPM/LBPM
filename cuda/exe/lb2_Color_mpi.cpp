...
*/	//......................................................................................
    ...
    while (timestep < timestepMax) {
        ...
        //...................................................................................
        /*		dvc_PackValues(faceGrid, packThreads, dvcRecvList_x, recvCount_x,recvbuf_x, Phi, N);
		dvc_PackValues(faceGrid, packThreads, dvcRecvList_y, recvCount_y,recvbuf_y, Phi, N);
		dvc_PackValues(faceGrid, packThreads, dvcRecvList_z, recvCount_z,recvbuf_z, Phi, N);
		dvc_PackValues(faceGrid, packThreads, dvcRecvList_X, recvCount_X,recvbuf_X, Phi, N);
		dvc_PackValues(faceGrid, packThreads, dvcRecvList_Y, recvCount_Y,recvbuf_Y, Phi, N);
		dvc_PackValues(faceGrid, packThreads, dvcRecvList_Z, recvCount_Z,recvbuf_Z, Phi, N);
*/		//...................................................................................
