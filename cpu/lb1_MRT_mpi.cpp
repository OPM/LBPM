		...
		for (j=0; j<Ny; j++){
			for (i=0; i<Nx; i++){
				...
				for (q=0; q<9; q++){
					...
					dist_even[(q+1)*N+n] = 100*(zn*X*Y+yn*X+xn) + 2*q+1;
					...
					dist_odd[q*N+n] =  100*(zn*X*Y+yn*X+xn) + 2*(q+1);
...
extern void GlobalCheckDebugDist(double *dist_even, double *dist_odd, int Nx, int Ny, int Nz, 
		int iproc, int jproc, int kproc, int nprocx, int nprocy, int nprocz)
{
		...
		for (j=0; j<Ny; j++){
			for (i=0; i<Nx; i++){
				...
				for (q=0; q<9; q++){
					...
					if (dist_even[(q+1)*N+n] != 100*(z*X*Y+y*X+x) + 2*(q+1)){
						printf("******************************************\n");
					...
					if (dist_odd[q*N+n] !=  100*(z*X*Y+y*X+x) + 2*q+1){
						printf("******************************************\n");
...
int main(int argc, char **argv)
{
	...
	if (rank == 0){
		printf("********************************************************\n");
		printf("Running Single phase MRT LBM	\n");
		printf("********************************************************\n");
	}
...
//	InitD3Q19(ID, f_even, f_odd, Nx, Ny, Nz);
	GlobalFlipInitD3Q19(f_even, f_odd, Nx-2, Ny-2, Nz-2,iproc,jproc,kproc,nprocx,nprocy,nprocz);
	...
	//...........................................................................	
		GlobalCheckDebugDist(f_even, f_odd, Nx-2, Ny-2, Nz-2,iproc,jproc,kproc,nprocx,nprocy,nprocz);
	//...........................................................................
